...
import { Text, View, Alert, FlatList, Image, ImageBackground, StyleSheet, SafeAreaView, Platform, StatusBar, TouchableOpacity } from 'react-native';
    ...
    renderItem = ({ item }) => {
        return (
            <View style={styles.contentCard}>
                <Image source={{ uri: item.agency.image_url === null ? 'https://raw.githubusercontent.com/pro-whitehatjr/PRO-C80-Template-/main/assets/space_crafts.png' : item.agency.image_url }} style={styles.itemImage}></Image>
